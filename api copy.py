...
#     draw.text((20, 50), f"{username}'s Score: {score}", fill='black', font=font)
#     draw.text((20, 100), "Join me in this game!", fill='black', font=font)

#     buffered = BytesIO()
#     img.save(buffered, format="PNG")
#     img_base64 = base64.b64encode(buffered.getvalue()).decode()

#     return jsonify({"image": f"data:image/png;base64,{img_base64}", "invite_link": f"http://localhost:3000/join/{user_id}"})
